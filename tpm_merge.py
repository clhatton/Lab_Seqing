...
base_path = '/data/rusers/hattonc/PRODMAT/HISAT2/TPM_txt/'
...
df_C.to_csv('HISAT2_C_TPM.csv', index=False)
df_M.to_csv('HISAT2_M_TPM.csv', index=False)
df_F.to_csv('HISAT2_F_TPM.csv', index=False)
